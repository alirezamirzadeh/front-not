// src/components/ui/CartContent.tsx

import { useCartStore } from "@/store/cartStore";
import { useMemo } from "react";
import { AnimatePresence, motion } from "framer-motion"; // تغییر ایمپورت
    ...
    return (
        <>
            ...
            <motion.div
                ...
                animate={{ height: items.length > 2 ? 380 : "auto" }}
                        ...
                        <AnimatePresence>
                            {items.length === 0 ? (
                                <motion.div
                                    ...
                                    className="flex h-full flex-col items-center justify-center gap-2 text-center pt-16"
                                >
