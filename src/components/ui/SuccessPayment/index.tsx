    ...
    return (
        <AnimatePresence>
            <motion.div initial={{ opacity: 0 }} exit={{ opacity: 0 }} animate={{ opacity: 1 }}>
                <div className="absolute   bg-black/80 backdrop-blur-sm top-0 left-0 overflow-hidden w-screen h-screen flex flex-col items-center justify-center px-4 gap-6 text-white">
